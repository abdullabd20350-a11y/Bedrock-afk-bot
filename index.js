...
// ==========================================
// 2. نظام الحركة والنشاط (Anti-AFK)
// ==========================================
function runActivity(id) {
    ...
    if (b.type === 'java') {
        ...
        try {
            let p = { ...b.pos };
            if (Math.random() > 0.5) p.y += 1; else p.x += 1;
...
<style>
    ...
    .xyz-box { font-family: monospace; background: #f8f9fa; padding: 10px; border-radius: 10px; margin: 10px 0; display: flex; gap: 10px; border: 1px solid #eee; }
    ...
    let cards = myBots.map(id => {
        ...
        <div class="bot-card" style="border-right: 6px solid ${b.connected?'#28a745':'#dc3545'};">
            <div style="display:flex; justify-content:space-between; align-items:center;">
                ...
                <span class="status-badge" style="background:${b.connected?'#d4edda':'#f8d7da'}">${state}</span>
            </div>
            <div class="xyz-box">
...
app.listen(process.env.PORT || 10000, () => console.log('🚀 Kinga Pro Dashboard Stable!'));
